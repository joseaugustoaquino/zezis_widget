...
import 'package:zezis_widget/data/rx_dart/src/utils/forwarding_sink.dart';
import 'package:zezis_widget/data/rx_dart/src/utils/forwarding_stream.dart';

/// The strategy that is used to determine how and when a window is created.
enum WindowStrategy {
  ...
  /// source [Stream] emits a next event, it opens a window.
...
class _BackpressureStreamSink<S, T> extends ForwardingSink<S, T> {
  ...
  // opens a Window which is kept open until the main Stream
  // closes.
...
/// how and when a window is created.
///
