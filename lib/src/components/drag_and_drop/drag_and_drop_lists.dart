...
import 'package:zezis_widget/src/components/drag_and_drop/drag_and_drop_list_target.dart';
import 'package:zezis_widget/src/components/drag_and_drop/drag_and_drop_list_wrapper.dart';
import 'package:zezis_widget/src/components/drag_and_drop/drag_handle.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:flutter/widgets.dart';

export 'package:zezis_widget/src/components/drag_and_drop/drag_and_drop_builder_parameters.dart';
export 'package:zezis_widget/src/components/drag_and_drop/drag_and_drop_item.dart';
...
class DragAndDropListsState extends State<DragAndDropLists> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.children.isNotEmpty) {
      Widget outerListHolder = const SizedBox();
  ...
  SliverList _buildSliverList(DragAndDropListTarget dragAndDropListTarget, DragAndDropBuilderParameters parameters) {
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
        (context, index) => _buildInnerList(index, childrenCount, dragAndDropListTarget, includeSeparators, parameters),
  ...
  List<Widget> _buildOuterList(DragAndDropListTarget dragAndDropListTarget, DragAndDropBuilderParameters parameters) {
    ...
    return List.generate(childrenCount, (index) => _buildInnerList(index, childrenCount, dragAndDropListTarget, includeSeparators, parameters));
  }
