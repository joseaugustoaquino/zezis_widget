...
import 'package:zezis_widget/src/components/rx_dart/src/utils/subscription.dart';
...
///
/// If you wish to combine the list of values into a object before you
///
///     CombineLatestStream(
///         Stream.fromIterable(['a']),
///         Stream.fromIterable(['b']),
...
class CombineLatestStream<T, R> extends StreamView<R> {
  ...
  /// The [combiner] maps this [List] into a event of type [R]
  CombineLatestStream(
  ...
  /// where [combiner] is used to create a event of type [R], based on the
