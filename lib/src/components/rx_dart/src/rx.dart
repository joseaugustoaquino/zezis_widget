...
import 'package:zezis_widget/src/components/rx_dart/streams.dart';
...
/// [rx_dart github repo](https://github.com/ReactiveX/rx_dart) demonstrating how
/// to use rx_dart with web, command line, and Flutter applications.
///
/// #### Additional Resources
///
/// In addition to the rx_dart documentation and examples, you can find many
...
///
///    - rx_dart works with any API that expects a Dart Stream as an input.
...
abstract class Rx {
  ...
  /// Creates a Stream that will recreate and re-listen to the source
  /// Stream when the notifier emits a value. If the source Stream
  ...
  /// a Stream is emitted from the source Stream and subscribe to the new
  /// Stream.
  ///
  /// ### Example
  ///
  ...
  /// the Stream will be the result of the function applied to the first
  /// item emitted by Stream #1 and the first item emitted by Stream #2;
  /// the second item emitted by the ZipStream will be the result of
