...
/// Initalize class
class ZLoadingButton extends StatefulWidget {
  /// Button controller, now required
  final ZLoadingButtonController controller;
...
class ZLoadingButtonState extends State<ZLoadingButton>
...
class ZLoadingButtonController {
